...
public class dbmanager extends SQLiteOpenHelper
{
   private static final String dbname="dbcontact";
    ...
    {
       String qry="create table tbl_contact ( id integer primary key autoincrement, name text, quan text, price text)";
    ...
    public  String addrecord(String name, String quan, String price)
    {
